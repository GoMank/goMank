            ...
            <div className="mx-6 py-10 text-center md:text-left">
                <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
                    ...
                    <div className="flex pl-8">
                        ...
                        Jakarta Selatan 12561
                        </p>
                    </div>
                    <div >
                        
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600 font-bold">Layanan</a>
                        </p>
                        <p className="">
                            <a href="#!" className="text-gray-600 ">Cuci Mobil</a>
                        </p>
                        <p className="">
                            <a href="#!" className="text-gray-600 ">Cuci Motor</a>
                        </p>
                        <p className="">
                            <a href="#!" className="text-gray-600 ">Servis Mobil</a>
                        </p>
                        <p className="">
                            <a href="#!" className="text-gray-600 ">Servis Motor</a>
                        </p>
                    ...
                    <div >
                        ...
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600 font-bold">Informasi</a>
                        </p>
                        <p className="">
                            <a href="#!" className="text-gray-600 ">Tentang Kami</a>
                        </p>
                        <p className="">
                            <a href="#!" className="text-gray-600 ">Harga</a>
                        </p>
                        <p className="">

...
describe(`GET /mamangs/:id--success`, () => {
    it('should return 200 ', async () => {
        await connectMongoDb()
        const res = await request(app).get('/mamangs/625cca23de74674f02791747')
        expect(res.status).toBe(200)
        expect(res.body).toHaveProperty('_id', '625cca23de74674f02791747')
...
describe(`GET /mamangs/nearest --success`, () => {
    it('should return 200 ', async () => {
        await connectMongoDb()
        const res = await request(app).post('/mamangs/nearest').send({ location: "[106.864,-6.254]" })
        expect(res.status).toBe(200)
...
describe(`GET /mamangs/nearest --failed empty location`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
        const res = await request(app).post('/mamangs/nearest').send({ location: "" })
...
describe(`POST /mamangs/login --failed invalid password`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
...
describe(`POST /mamangs/login --failed invalid email`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
...
describe(`POST /mamangs/login --failed empty password`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
...
describe(`POST /mamangs/login --failed empty email`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
...
describe(`POST /mamangs/register --success`, () => {
...
describe(`POST /mamangs/login --success`, () => {
    it('should return 200 ', async () => {
        await connectMongoDb()
        const body = { email: "testMamang@mail.com", password: "12345" }
        const res = await request(app).post('/mamangs/login').send(body)
        expect(res.status).toBe(200)
        expect(res.body).toHaveProperty('_id', expect.any(String))
        expect(res.body).toHaveProperty('email', "testMamang@mail.com")
...
describe(`POST /mamangs/register --failed email empty`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
        const body = {
            email: '',
...
describe(`POST /mamangs/register --failed password empty`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
        const body = {
            email: 'testMamang@mail.com',
...
describe(`POST /mamangs/register --failed phoneNumber empty`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
        const body = {
            email: 'testMamang@mail.com',
...
describe(`POST /mamangs/register --failed name empty`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
        const body = {
            email: 'testMamang@mail.com',
...
describe(`POST /mamangs/register --failed gender empty`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
        const body = {
            email: 'testMamang@mail.com',
...
describe(`POST /mamangs/register --failed address empty`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
        const body = {
            email: 'testMamang@mail.com',
...
describe(`POST /mamangs/register --failed image empty`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
        const body = {
            email: 'testMamang@mail.com',
...
describe(`POST /mamangs/register --failed rekNumber empty`, () => {
    it('should return 400 ', async () => {
        await connectMongoDb()
        const body = {
            email: 'testMamang@mail.com',
...
describe(`DELETE /mamangs/:id --success`, () => {
    it('should return 200 ', async () => {
        const res = await request(app).delete('/mamangs/625ccc933640c303de2848f2')
        expect(res.status).toBe(200)
...
describe(`PATCH /mamangs/address/:id --success`, () => {
    it('should return 200 ', async () => {
        const res = await request(app).patch('/mamangs/address/625cca23de74674f02791747')
...
describe(`PATCH /mamangs/:id --success`, () => {
    it('should return 200 ', async () => {
        const res = await request(app).patch('/mamangs/625cca23de74674f02791747')
            .send({ saldo: 5000 })
        expect(res.status).toBe(200)
        expect(res.body).toHaveProperty('_id', expect.any(String))
        expect(res.body).toHaveProperty('email', expect.any(String))
...
describe(`DELETE /mamangs/:id --failed without connecting to mongoDB`, () => {
    it('should return 500 ', async () => {
        const res = await request(app).delete('/mamangs/625cca24de74674f02791748')
        expect(res.status).toBe(500)
...
describe(`PATCH /mamangs/:id --failed without connecting to mongoDB`, () => {
    it('should return 500 ', async () => {
        const res = await request(app).patch('/mamangs/625cca24de74674f02791748').send({ saldo: 5000 })
        expect(res.status).toBe(500)
...
describe(`PATCH /mamangs/address/:id --failed without connecting to mongoDB`, () => {
    it('should return 500 ', async () => {
        const res = await request(app).patch('/mamangs/address/625cca24de74674f02791748')
            .send({ address: "[107.01118835699735,-6.269429087104287]" })
        expect(res.status).toBe(500)
